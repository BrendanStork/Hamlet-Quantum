...
Hamlet connects many-body physics, quantum information, and quantum computation through a unified software architecture, and is motivated by a foundational goal of quantum computing: using quantum computers to simulate quantum systems.
